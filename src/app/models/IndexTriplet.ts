...
import { IndexTexture } from './IndexTexture';
export class IndexTriplet extends IndexTexture
{
    constructor(vertexIndex?: number, textureCoordinateIndex?: number, normalIndex?: number)
    {
      super(vertexIndex, textureCoordinateIndex);
      if (normalIndex != null)
      {
    ...
    /**
     * TODO: switch over to TriangleGeometryIndicies, TriangleTextureIndicies, TriangleLightingIndicies when there is time
